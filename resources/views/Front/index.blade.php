...
@section('content')
	<body class="font-[Poppins] pb-[72px]">
		...
		<nav id="Category" class="max-w-[1130px] mx-auto flex justify-center items-center gap-4 mt-[30px]">
            ...
            <a href="{{ route('front.category', $category->slug) }}" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#FF69B4] hover:ring-2 hover:ring-[#FF69B4]">
                    ...
                    <div class="featured-news-card relative w-full h-[550px] flex shrink-0 overflow-hidden">
                        ...
                        <div class="card-detail max-w-[1130px] w-full mx-auto flex items-end justify-between pb-10 relative z-20">
                            ...
                            <div class="prevNextButtons flex items-center gap-4 mb-[60px]">
                                <button class="button--previous appearance-none w-[38px] h-[38px] flex items-center justify-center rounded-full shrink-0 ring-1 ring-white hover:ring-2 hover:ring-[#FF69B4] transition-all duration-300">
                                    <img src="assets/images/icons/arrow.svg" alt="arrow" />
                                </button>
                                <button class="button--next appearance-none w-[38px] h-[38px] flex items-center justify-center rounded-full shrink-0 ring-1 ring-white hover:ring-2 hover:ring-[#FF69B4] transition-all duration-300 rotate-180">
                                    <img src="assets/images/icons/arrow.svg" alt="arrow" />
                                </button>
                            </div>
                        </div>
		...
		<section id="Up-to-date" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			<div class="flex items-center justify-between">
				...
				<p class="badge-orange rounded-full p-[8px_18px] bg-[#FF69B4] font-bold text-sm leading-[21px] text-[#FFFFFF] w-fit">UP TO DATE</p>
			</div>
			<div class="grid grid-cols-3 gap-[30px]">

                @forelse ($articles as $article)
                    <a href="{{ route('front.details', $article->slug) }}" class="card-news">
                        <div class="rounded-[20px] ring-1 ring-[#FF69B4] p-[26px_20px] flex flex-col gap-4 hover:ring-2 hover:ring-[#FF69B4] transition-all duration-300 bg-white">
		...
		<section id="Best-authors" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			<div class="flex flex-col text-center gap-[14px] items-center">
				<p class="badge-orange rounded-full p-[8px_18px] bg-[#FF69B4] font-bold text-sm leading-[21px] text-[#FFFFFF] w-fit">BEST AUTHORS</p>
				<h2 class="font-bold text-[26px] leading-[39px]">
			...
			<div class="grid grid-cols-6 gap-[30px]">
                ...
                @forelse ($authors as $author)
                    <a href="{{ route('front.author', $author->slug) }}" class="card-authors">
                        <div class="rounded-[20px] border border-[#FF69B4] p-[26px_20px] flex flex-col items-center gap-4 hover:ring-2 hover:ring-[#FF69B4] transition-all duration-300">
		...
		<section id="Advertisement" class="max-w-[1130px] mx-auto flex justify-center mt-[70px]">
			<div class="flex flex-col gap-3 shrink-0 w-fit">
				<a href="{{ $bannerads->link }}">
					<div class="w-[900px] h-[120px] flex shrink-0 border border-[#FF69B4] rounded-2xl overflow-hidden">
		...
		<section id="Latest-entertainment" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			<div class="flex items-center justify-between">
				...
				<a href="{{ route('front.category', 'Entertainment')}}" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#FF69B4] hover:ring-2 hover:ring-[#FF69B4]">Explore All</a>
			</div>
					...
					<div class="w-[455px] flex flex-col gap-5 shrink-0">
                        ...
                        @forelse ($entertainment_articles as $article)
                            <a href="{{ route('front.details', $article->slug) }}" class="card py-[2px]">
                                <div class="rounded-[20px] border border-[#FF69B4] p-[14px] flex items-center gap-4 hover:ring-2 hover:ring-[#FF69B4] transition-all duration-300">
		...
		<section id="Latest-business" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			<div class="flex items-center justify-between">
				...
				<a href="{{ route('front.category', 'Business')}}" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#FF69B4] hover:ring-2 hover:ring-[#FF69B4]">Explore All</a>
			</div>
			<div class="flex items-center justify-between h-fit">
				<div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
				...
				<div class="h-[424px] w-fit px-5 overflow-y-scroll overflow-x-hidden relative custom-scrollbar">
					<div class="w-[455px] flex flex-col gap-5 shrink-0">
                        ...
                        @forelse ($business_articles as $article)
                            <a href="{{ route('front.details', $article->slug) }}" class="card py-[2px]">
                                <div class="rounded-[20px] border border-[#EEF0F7] p-[14px] flex items-center gap-4 hover:ring-2 hover:ring-[#FF69B4] transition-all duration-300">
                                    <div class="w-[130px] h-[100px] flex shrink-0 rounded-[20px] overflow-hidden">
                                        <img src="{{ Storage::url($article->thumbnail) }}" class="object-cover w-full h-full" alt="thumbnail" />
                                    </div>
                                    <div class="flex flex-col justify-center-center gap-[6px]">
		...
		<section id="Latest-automotive" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
			<div class="flex items-center justify-between">
				...
				<a href="{{ route('front.category', 'Automotive ')}}" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#FF69B4] hover:ring-2 hover:ring-[#FF69B4]">Explore All</a>
			</div>
			<div class="flex items-center justify-between h-fit">
				<div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
					<img src="{{ Storage::url($automotive_featured_articles->thumbnail) }}" class="absolute object-cover w-full h-full thumbnail" alt="icon" />
					<div class="w-full h-full bg-gradient-to-b from-[rgba(0,0,0,0)] to-[rgba(0,0,0,0.9)] absolute z-10"></div>
					<div class="card-detail w-full flex items-end p-[30px] relative z-20">
						<div class="flex flex-col gap-[10px]">
							<p class="text-white">Featured</p>
							<a href={{ route('front.details', $automotive_featured_articles->slug)}} class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">
