...
<body class="font-[Poppins]">
			...
			<div id="More-from-author" class="flex flex-col gap-4">
                ...
                @forelse ($author_news as $item_news)
                    <a href="{{ route('front.details', $item_news->slug) }}" class="card-from-author">
                        <div
                            class="rounded-[20px] ring-1 ring-[#FF69B4] p-[14px] flex gap-4 hover:ring-2 hover:ring-[#FF69B4] transition-all duration-300">
	...
	<section id="Up-to-date" class="w-full flex justify-center mt-[70px] py-[50px] bg-[#FF69B4]">
